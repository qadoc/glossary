...
def scan_dir(dir_path='.', level=0):
    ...
    def create_dir_index_file(dir_path):
        ...
        if (os.path.isfile(dir_index_file_path)):
            # Clear existing file
            open(dir_index_file_path, 'w', encoding='utf-8').close()

        # Compose the index file
        index_file = open(dir_index_file_path, 'w',encoding='utf-8')
        ...
        for entry_file_name in entries:
            ...
            index_file.write(f"- [{entry_display_name}]({entry_path_encode})\n")
    ...
    def write_entry_in_sidebar(entry_path, index=False):
        ...
        sidebar_file = open('_sidebar.md', 'a',encoding='utf-8')
    ...
    def execute():
        ...
        if level == 0:
            ...
            open('_sidebar.md', 'w',encoding='utf-8').close()
